...
public enum ActiveRole {
    ...
    BUYER(Set.of("MANAGE_PROFILE", "SELECT_ROLE", "REGISTER_STORE", "REGISTER_DRIVER", "MANAGE_CART", "MANAGE_WALLET")),
    SELLER(Set.of("MANAGE_PROFILE", "SELECT_ROLE", "MANAGE_PRODUCT", "REGISTER_DRIVER", "MANAGE_WALLET")),
    DRIVER(Set.of("MANAGE_PROFILE", "SELECT_ROLE", "REGISTER_STORE", "MANAGE_WALLET"));
